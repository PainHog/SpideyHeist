...
| `dist/Heisty_Spideys_v4.4.pdf` | The typeset, illustrated edition (current) |
...
```bash
npm install
npm run build:book                                         # → book/dist/Heisty_Spideys_v4.4.pdf
python3 book/tools/text-diff.py book/original/Heisty_Spideys_v4_1.pdf book/dist/Heisty_Spideys_v4.4.pdf   # word-level check vs the original
```
